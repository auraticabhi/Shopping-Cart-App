...
const Cart = () => {
  ...
  <div className="max-w-6xl   mx-auto">
    ...
    <div className="w-full md:w-[40%] flex flex-col p-5 gap-5 justify-between my-20 ml-5  ">
      ...
      <div>
        <p className="text-xl dark:text-gray-100 font-semibold text-slate-700">Total Amount: <span className="text-slate-900 dark:text-gray-50 font-bold">${totalAmount.toFixed(2)}</span></p>
       <NavLink to="#">
       <button onClick={()=>{alert("Nice Choice")}} className="bg-green-700 w-full hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl">
          Checkout Now
        </button>
       </NavLink>
      </div>
